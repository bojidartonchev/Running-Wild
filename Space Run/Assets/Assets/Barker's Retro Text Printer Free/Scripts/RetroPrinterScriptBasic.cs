...
public class RetroPrinterScriptBasic : MonoBehaviour {
	...
	void Start () {
        ...
        FullText.Add("You have been sent to space to explore the galaxy and search for other species.");
        FullText.Add("Throughout your journey the engine breaks and explodes, causing you to crash.");
        FullText.Add("Your task is to survive and gather ship parts in order to go back home.");
		Init();
